                                    ...
                                    <div class="card-body">
                                        <div>
                                            ...
                                            <fieldset>
                                                ...
                                                <form  class="form-remove-locale" method="POST" role="form" action="<?php echo action('\acmepackage\TranslationManager\Controller@postRemoveLocale') ?>" data-confirm="Are you sure to remove this locale and all of data?">
                                                ...
                                                <form class="form-add-locale" method="POST" role="form" action="<?php echo action('\acmepackage\TranslationManager\Controller@postAddLocale') ?>">
                                                    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                                    <div class="form-group">
                                                        <p>
